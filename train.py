...
def train(hyp, opt, device, callbacks):
    ...
    amp = check_amp(model, opt.imgsz)  # check AMP
...
def parse_opt(known=False):
    seed = 0
    data = '/home/jndx01/yang/yolov5-master2/data/547.yaml'
    cfg = '/home/jndx01/yang/yolov5-master2/models/paper/yolov5s-KSFA.yaml'
    name = cfg.split('/')[-1].replace('.yaml', '_') + data.split('/')[-1].replace('.yaml', '') + '_' + str(seed)
