...
def parse_opt(known=False):
    ...
    parser.add_argument("--data", type=str, default=ROOT / "data/599.yaml", help="dataset.yaml path")
    parser.add_argument("--weights", nargs="+", type=str, default="/home/jndx01/yang/yolov5-master/runs/train/yolov11_599_c3k2psa+head+NWD0.5_546/weights/best.pt", help="model.pt path(s)")
    parser.add_argument("--imgsz", "--img", "--img-size", nargs="+", type=int, default=[2048, 2048], help="image (h, w)")
